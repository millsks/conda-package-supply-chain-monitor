...
class PoliciesConfig(AppConfig):
    ...
    `name` is `conda_sentinel.policies`, never
    `django_apps.conda_sentinel.policies`:
    ...
    **It declares `ready()`, and it is the second adopted application that
    ...
    def ready(self) -> None:
        ...
        **No refusal is evaluated here, and that is a difference from
        ...
        from conda_sentinel.core.policy import pass_registrations  # noqa: PLC0415 - see above
        from conda_sentinel.core.policy import register_pass  # noqa: PLC0415 - see above
